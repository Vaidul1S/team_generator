  ...
  return (
    <View style={styles.container}>
      <Image
        ...
        style={styles.image} />
      <Text style={styles.text}>Team generator for pairing people into teams.</Text>
      ...
      <Text style={styles.text}>Added Tornament Bracket (Single elimination, 2 groups)</Text>
